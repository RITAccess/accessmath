...
+ (instancetype)sharedIndex {
    ...
    dispatch_once(&onceToken, ^{
        shared = [[AMIndex alloc] initWithIndex:[NSURL URLWithString:[[[@"~" stringByExpandingTildeInPath] stringByAppendingPathComponent:@"tmp"] stringByAppendingPathComponent:@"fs_index.db"]]];
    });
    return shared;
}
