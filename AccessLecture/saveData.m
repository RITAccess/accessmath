...
static NSString* const stacked = @"stacked";
static NSString* const stacked2 = @"stacked2";
static NSString* const stacked3 = @"stacked3";

static NSString* const statPos = @"statPos";
static NSString* const statPos2 = @"statPos2";
static NSString* const statPos3 = @"statPos3";

static NSString* const isAllStacked = @"isAllStacked";
...
- (instancetype)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self) {
        ...
        _isAllStacked = [decoder decodeBoolForKey:isAllStacked];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeBool:self.isAllStacked forKey:isAllStacked];
}
